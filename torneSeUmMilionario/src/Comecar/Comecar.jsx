...
export function Comecar() {
  ...
  const questoes = [
    ...
    },
    {
      id: 2,
      pergunta:
        "Qual o nome do artista que lançou o álbum 'Midnights' em 2022?",
    ...
    },
    {
      id: 3,
      pergunta:
        "Qual série da Netflix é conhecida por sua temática de sobrevivência e jogos mortais?",
      alternativas: [
        "La Casa de Papel",
        "Round 6",
        "The Witcher",
    ...
    },
    {
      id: 4,
      pergunta:
        "Qual filme da Marvel foi lançado em 2021 e apresenta o personagem Shang-Chi?",
      alternativas: [
        "Black Widow",
        "Eternals",
    ...
    },
    {
      id: 11,
      pergunta:
        "Qual série de animação é conhecida por sua crítica social e humor ácido, criada por Matt Groening?",
      alternativas: [
        "Futurama",
        "Os Simpsons",
        "Rick and Morty",
    ...
    },
    {
      id: 12,
      pergunta:
        "Qual foi o fenômeno viral que trouxe de volta a música 'Running Up That Hill' de Kate Bush em 2022?",
    ...
    },
    {
      id: 14,
      pergunta:
        "Qual é o nome do filme que apresenta a história do cantor Elvis Presley?",
      alternativas: [
        "Rocketman",
        "Bohemian Rhapsody",
        "Elvis",
    ...
    },
    {
      id: 16,
      pergunta:
        "Qual série de sucesso da HBO é baseada nos livros de George R.R. Martin?",
      alternativas: [
        "Westworld",
        "Game of Thrones",
        "Succession",
    ...
    },
    {
      id: 18,
      pergunta:
        "Qual a série de Netflix que segue a vida de uma adolescente chamada Anne?",
      alternativas: [
        "Anne with an E",
        "The Queen's Gambit",
        "Outer Banks",
    ...
    },
    {
      id: 19,
      pergunta:
        "Qual filme da Disney apresentou a história de um jovem príncipe chamado Aladdin?",
    ...
    },
    {
      id: 20,
      pergunta:
        "Qual série é conhecida por ter como tema a vida de uma família disfuncional chamada Bluth?",
      alternativas: [
        "The Office",
    ...
    },
    {
      id: 21,
      pergunta:
        "Qual é o nome do filme de super-herói que apresenta o personagem 'Wanda Maximoff'?",
      alternativas: [
        "Doctor Strange",
        "Avengers: Endgame",
        "WandaVision",
    ...
    },
    {
      id: 22,
      pergunta:
        "Qual a série que apresenta um grupo de amigos que jogam Dungeons & Dragons?",
      alternativas: [
        "The Big Bang Theory",
        "Stranger Things",
        "Brooklyn Nine-Nine",
    ...
    },
    {
      id: 24,
      pergunta:
        "Qual a série que acompanha uma família real fictícia na Inglaterra?",
    ...
    },
    {
      id: 25,
      pergunta:
        "Qual é o nome do ator que interpreta o personagem 'Peter Parker' no filme 'Spider-Man'?",
      alternativas: [
        "Andrew Garfield",
        "Tobey Maguire",
        "Tom Holland",
    ...
    },
    {
      id: 27,
      pergunta:
        "Qual série da HBO foi baseada em uma série de livros de fantasia escrita por Robert Jordan?",
      alternativas: [
        "The Witcher",
        "The Wheel of Time",
        "Shadow and Bone",
    ...
    },
    {
      id: 28,
      pergunta:
        "Qual é o nome do artista que ficou famoso por sua performance em 'Old Town Road'?",
    ...
    },
    {
      id: 29,
      pergunta:
        "Qual filme de terror de 2022 foi um sucesso na bilheteira, dirigido por Jordan Peele?",
    ...
    },
    {
      id: 30,
      pergunta:
        "Qual é a série que segue a vida de um advogado chamado Jimmy McGill?",
    ...
    },
    {
      id: 31,
      pergunta:
        "Quem interpretou o papel de 'Harley Quinn' no filme 'Esquadrão Suicida'?",
      alternativas: [
        "Margot Robbie",
        "Emma Stone",
        "Scarlett Johansson",
    ...
    },
    {
      id: 32,
      pergunta:
        "Qual é o nome da série que apresenta um grupo de jovens que viajam no tempo para resolver mistérios?",
      alternativas: [
        "Dark",
    ...
    },
    {
      id: 34,
      pergunta:
        "Qual série da Disney+ segue as aventuras de um grupo de jovens Jedi?",
      alternativas: [
        "The Mandalorian",
    ...
    },
    {
      id: 36,
      pergunta:
        "Qual é o nome do grupo que lançou a música 'Good 4 U' em 2021?",
    ...
    },
    {
      id: 37,
      pergunta:
        "Qual é o nome da série que retrata a vida da rainha Elizabeth II?",
      alternativas: [
        "The Crown",
        "Victoria",
        "The Queen's Gambit",
    ...
    },
    {
      id: 38,
      pergunta:
        "Qual a série de Netflix que segue um grupo de adolescentes durante o verão em uma ilha?",
      alternativas: [
        "Outer Banks",
    ...
    },
    {
      id: 43,
      pergunta:
        "Qual é o nome da artista que lançou a música 'Watermelon Sugar'?",
      alternativas: [
        "Harry Styles",
        "Ed Sheeran",
        "Shawn Mendes",
    ...
    },
    {
      id: 44,
      pergunta:
        "Qual é a série que se passa em um mundo pós-apocalíptico e segue um grupo de sobreviventes?",
      alternativas: [
        "The Walking Dead",
        "The 100",
    ...
    },
    {
      id: 46,
      pergunta:
        "Qual é o nome do rapper que lançou o álbum 'Certified Lover Boy'?",
    ...
    },
    {
      id: 47,
      pergunta:
        "Qual é o nome do filme que apresenta uma história de amor entre dois adolescentes em meio a uma pandemia?",
      alternativas: [
    ...
    },
    {
      id: 48,
      pergunta:
        "Qual é a série que segue a vida de uma jovem com habilidades mágicas?",
      alternativas: [
    ...
    },
    {
      id: 50,
      pergunta:
        "Qual artista lançou a música 'Stay' em colaboração com Justin Bieber?",
      alternativas: [
        "The Kid LAROI",
        "Shawn Mendes",
        "Post Malone",
  ...
  const handleRespostaSelecionada = (alternativa) => {
    if (respostaSelecionada === null) {
      ...
      if (alternativa === questoes[indiceAtual].resposta) {
        ...
        const montanteFormatado = new Intl.NumberFormat("pt-BR", {
          style: "currency",
          currency: "BRL",
        }).format(novoMontante);
        setFeedback(
          `Correto! Você está perto de se tornar um milionário! Você ganhou R$ 20.000,00, Seu montante total é de ${montanteFormatado}`
        );
        ...
        if (tentativas - 1 === 0) {
          ...
          setFeedback(
            `Incorreto! Preste mais atenção na próxima. Restam ${
              tentativas - 1
            } tentativas.`
          );
        }
                ...
                {questoes[indiceAtual].alternativas.map((alternativa) => (
                  <li
                    ...
                    style={{
                      cursor: "pointer",
                      fontWeight:
                        respostaSelecionada === alternativa ? "bold" : "normal",
                      color: respostaSelecionada
                        ? alternativa === questoes[indiceAtual].resposta
                          ? "green"
                          : "red"
                        : "black", // Cor para feedback visual
                    }}
                  >
                    {alternativa}
                  </li>
